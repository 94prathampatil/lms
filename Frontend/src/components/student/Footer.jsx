    ...
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
      <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
        <div className="flex flex-col md:items-start items-center w-full">
          <img className="w-28" src={assets.logo_dark} alt="Logo" />
          <p className="mt-6 text-center md:text-left text-sm text-white/80">
            We bring world-class instructors, interactive content, and a
        ...
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <ul className="flex md:flex-col w-full justify-between text-white/80 md:space-y-2">
            <li>
              <a href="#">Home</a>
            </li>
            <li>
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <p className="text-sm text-white/80">
            The latest technical news, articles, and resources, sent to your
            inbox weekly.
          </p>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-white/60">
        2025 &copy; EduHut WCE. All rights reserved.
      </p>
    </footer>
  );
};
